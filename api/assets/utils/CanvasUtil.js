/**
 * Canvas工具类（目前只有画箭头工具类）
 * @see https://www.w3cplus.com/canvas/drawing-arrow.html
 */
'use strict'
...
const drawArrow = (ctx, x1, y1, x2, y2, style, which, angle, d, color, width) => {
  ...
  // draw arced arrow
const drawArcedArrow = (ctx, x, y, r, startangle, endangle, anticlockwise, style, which, angle, d, color, width) => {
    style = typeof(style) != 'undefined' ? style : 3;
    which = typeof(which) != 'undefined' ? which : 1;
